          ...
          >
            ...
            >
              <Dialog.Panel
                data-testid={dataTestId}
                className={clx(
                  "flex flex-col justify-start w-full transform p-5 text-left align-middle transition-all max-h-[85vh] h-fit",
                  {
                    "max-w-md": size === "small",
...
const Footer: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
    <div className="flex w-full items-center justify-end gap-x-4 pt-3">
      {children}
    </div>
  )
}
